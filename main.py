...
class Alarm:
    ...
    def check_json(self):
        ...
        '''
        last_saved=os.path.getmtime('/Users/steph/Desktop/Coding/projects/security/server/Control.json')
        if self.last_update != last_saved:
            self.last_update = last_saved
            f=open('/Users/steph/Desktop/Coding/projects/security/server/Control.json','r') #fix this file path
    ...
    def update_state(self):
        ...
        if self.loop_status == self.state:
            ...
            f=open('/Users/steph/Desktop/Coding/projects/security/server/State.json', 'w') #fix this file path
            f.write(json_data)
            f.close()
